...
function getAverage(value1, value2) {
    ...
    return (sum === Infinity) ? (Math.abs(value1 - value2) / 2) + Math.min(value1, value2) : (value1 + value2) / 2;
}
...
function getLastDigit(value) {
    ...
    return string_value[string_value.length - 1];
}
